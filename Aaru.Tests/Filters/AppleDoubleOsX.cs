...
public class AppleDoubleOsX
{
    ...
    readonly string _location = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "osx", "DOS_720.dmg");
    readonly string _sidecar = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "osx", "._DOS_720.dmg");
