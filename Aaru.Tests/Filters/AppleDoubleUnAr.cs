...
public class AppleDoubleUnAr
{
    ...
    readonly string _location = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "unar", "DOS_720.dmg");
    readonly string _sidecar = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "unar", "DOS_720.dmg.rsrc");
