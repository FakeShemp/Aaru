...
public class AppleDoubleDos
{
    ...
    readonly string _location = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "dos", "DOS_720.dmg");
    readonly string _sidecar = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "dos", "DOS_720.adf");
