...
public class AppleDoubleProDos
{
    ...
    readonly string _location = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "prodos", "DOS_720.dmg");
    readonly string _sidecar = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "prodos", "R.DOS_720.dmg");
