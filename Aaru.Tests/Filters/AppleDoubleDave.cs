...
public class AppleDoubleDave
{
    ...
    readonly string _location = Path.Combine(Consts.TestFilesRoot, "Filters", "AppleDouble", "dave", "DOS_720.dmg");
    readonly string _sidecar = Path.Combine(Consts.TestFilesRoot,
                                            "Filters",
                                            "AppleDouble",
                                            "dave",
                                            "resource.frk",
