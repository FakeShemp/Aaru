...
public class ExtendedCSD
{
    ...
    [
        new()
        {
            ...
            MaxEnhancedAreaSize = [52, 19, 0],
            PartitioningSupport =
                PartitioningSupport.Supported | PartitioningSupport.Enhanced | PartitioningSupport.Extended,
            HPIManagement = 1,
            HWResetFunction = 1,
            ...
            Reserved5 = 0,
            BootAreaWriteProtectionRegister =
                BootAreaWriteProtectionRegister.PowerOn | BootAreaWriteProtectionRegister.PermanentDisable,
            BootWriteProtectionStatus = 5,
            HighCapacityEraseGroupDefinition = HighCapacityEraseGroupDefinition.Enabled,
            Reserved6 = 0,
            BootBusConditions = 0,
            ...
            Reserved13 = 0,
            DeviceType =
                DeviceType.HS_26 | DeviceType.HS_52 | DeviceType.HS_DDR_52 | DeviceType.HS200_18 | DeviceType.HS400_18,
            DriverStrength = DriverStrength.Type0,
            ...
            SecureWriteProtectInformation = SecureWriteProtectInformation.Supported,
            ...
            Reserved15 = 0,
            BootInformation = BootInformation.Alternative | BootInformation.DDR | BootInformation.HighSpeed,
            SecureTRIMMultiplier = 17,
            SecureEraseMultiplier = 27,
            SecureFeatureSupport =
                SecureFeatureSupport.Purge     |
                SecureFeatureSupport.Defective |
                SecureFeatureSupport.Trim      |
                SecureFeatureSupport.Sanitize,
            TRIMMultiplier = 5,
            Reserved16 = 0,
            ...
            Reserved17 = 0,
            CMDQueuingDepth = 31,
            CMDQueuingSupport = CMDQueuingSupport.Supported,
            Reserved18 = new byte[177],
            BarrierSupport = 0,
            FFUArgument = 0,
            OperationCodesTimeout = 0,
            FFUFeatures = 0,
            SupportedModes = SupportedModes.FFU | SupportedModes.VendorSpecific,
            ExtendedPartitionsSupport = ExtendedPartitionsSupport.SystemCode | ExtendedPartitionsSupport.NonPersistent,
            LargeUnitSize = 7,
            ContextManagementCaps = 5,
            TagResourcesSize = 0,
            TagUnitSize = 3,
            DataTagSupport = DataTagSupport.Supported,
            MaxPackedWriteCommands = 63,
            MaxPackedReadCommands = 63,
            BackgroundOperationsSupport = BackgroundOperationsSupport.Supported,
            HPIFeatures = HPIFeatures.Supported,
            SupportedCommandSets = DeviceSupportedCommandSets.Standard,
    ...
    public void Test()
    {
        for(var i = 0; i < _ecsd.Length; i++)
        {
            ...
            csd.Should().NotBeNull(Localization.Not_decoded_0, i);
