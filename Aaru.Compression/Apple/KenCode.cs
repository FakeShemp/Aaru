...
public partial class KenCode
{
    ...
    private static partial int AARU_kencode_decode_buffer(byte[] dst_buffer, ref nint dst_size, byte[] src_buffer,
                                                          nint   src_size);
    ...
    public static int DecodeBuffer(byte[] source, byte[] destination)
    {
        ...
        AARU_kencode_decode_buffer(destination, ref destLen, source, source.Length);
