...
public partial class DeflateStream : Stream
{
    ...
    public DeflateStream(Stream compressedStream, long decompressedLength)
    {
        ...
        int err = AARU_stuffitx_deflate_decode_buffer(_decoded, ref outLen, inBuf, inBuf.Length);

        if(err != 0) throw new InvalidOperationException("Deflate decompression failed");
    ...
    public static partial int AARU_stuffitx_deflate_decode_buffer(byte[] dst_buffer, ref nint dst_size,
