...
using Aaru.Devices;
using Aaru.Logging;
using AacsAuth = Aaru.Decryption.Aacs.AacsAuth;
...
#region Writable Blu-ray only
        ...
        ReadAacsKeysFromDrive(dskType, mediaTags);
    ...
    /// <summary>
    ///     AACS drive-key extraction. For HD DVD-ROM and BD-ROM media, when an AACS host key file
    ///     has been supplied via <c>--aacs-keydb-file</c>, run the AACS Drive Authentication
