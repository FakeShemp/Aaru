...
public static class VendorString
{
    ...
    public static string Prettify(string scsiVendorString) => scsiVendorString switch
                                                              {
                                                                  "0B4C" => "MOOSIK Ltd.",
                                                                  "13FE" => "PHISON",
