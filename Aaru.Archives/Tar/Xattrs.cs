...
#region IArchive Members
    ...
    public ErrorNumber ListXAttr(int entryNumber, out List<string> xattrs)
    {
        ...
        if(!string.IsNullOrEmpty(_entries[entryNumber].Comment)) xattrs.Add("comment");
    ...
    public ErrorNumber GetXattr(int entryNumber, string xattr, ref byte[] buffer)
    {
        ...
        if(xattr != "comment" || string.IsNullOrEmpty(entry.Comment)) return ErrorNumber.NoSuchExtendedAttribute;
