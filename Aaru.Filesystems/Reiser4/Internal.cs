...
public sealed partial class Reiser4
{
    ...
    sealed class Reiser4DirNode : IDirNode
    {
    ...
    /// <summary>File node for streaming reads</summary>
    sealed class Reiser4FileNode : IFileNode
    {
        /// <summary>Key of the file's stat-data, used for tree lookups of file body items</summary>
        internal LargeKey StatDataKey { get; init; }
