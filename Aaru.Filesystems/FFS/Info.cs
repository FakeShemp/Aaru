...
#region IFilesystem Members
                               ...
                               out FileSystem metadata)
    {
        ...
        AaruConsole.Debug(MODULE_NAME, "sb offset: 0x{0:X8}",    sb_offset);
        AaruConsole.Debug(MODULE_NAME, "fs_rlink: 0x{0:X8}",     sb.fs_rlink);
        AaruConsole.Debug(MODULE_NAME, "fs_sblkno: 0x{0:X8}",    sb.fs_sblkno);
        AaruConsole.Debug(MODULE_NAME, "fs_cblkno: 0x{0:X8}",    sb.fs_cblkno);
        AaruConsole.Debug(MODULE_NAME, "fs_iblkno: 0x{0:X8}",    sb.fs_iblkno);
        AaruConsole.Debug(MODULE_NAME, "fs_dblkno: 0x{0:X8}",    sb.fs_dblkno);
        AaruConsole.Debug(MODULE_NAME, "fs_size: 0x{0:X8}",      sb.fs_size);
        AaruConsole.Debug(MODULE_NAME, "fs_dsize: 0x{0:X8}",     sb.fs_dsize);
        AaruConsole.Debug(MODULE_NAME, "fs_ncg: 0x{0:X8}",       sb.fs_ncg);
        AaruConsole.Debug(MODULE_NAME, "fs_bsize: 0x{0:X8}",     sb.fs_bsize);
        AaruConsole.Debug(MODULE_NAME, "fs_fsize: 0x{0:X8}",     sb.fs_fsize);
        AaruConsole.Debug(MODULE_NAME, "fs_frag: 0x{0:X8}",      sb.fs_frag);
        AaruConsole.Debug(MODULE_NAME, "fs_minfree: 0x{0:X8}",   sb.fs_minfree);
        AaruConsole.Debug(MODULE_NAME, "fs_bmask: 0x{0:X8}",     sb.fs_bmask);
        AaruConsole.Debug(MODULE_NAME, "fs_fmask: 0x{0:X8}",     sb.fs_fmask);
        AaruConsole.Debug(MODULE_NAME, "fs_bshift: 0x{0:X8}",    sb.fs_bshift);
        AaruConsole.Debug(MODULE_NAME, "fs_fshift: 0x{0:X8}",    sb.fs_fshift);
        AaruConsole.Debug(MODULE_NAME, "fs_maxcontig: 0x{0:X8}", sb.fs_maxcontig);
        AaruConsole.Debug(MODULE_NAME, "fs_maxbpg: 0x{0:X8}",    sb.fs_maxbpg);
        AaruConsole.Debug(MODULE_NAME, "fs_fragshift: 0x{0:X8}", sb.fs_fragshift);
        AaruConsole.Debug(MODULE_NAME, "fs_fsbtodb: 0x{0:X8}",   sb.fs_fsbtodb);
        AaruConsole.Debug(MODULE_NAME, "fs_sbsize: 0x{0:X8}",    sb.fs_sbsize);
        AaruConsole.Debug(MODULE_NAME, "fs_csmask: 0x{0:X8}",    sb.fs_csmask);
        AaruConsole.Debug(MODULE_NAME, "fs_csshift: 0x{0:X8}",   sb.fs_csshift);
        AaruConsole.Debug(MODULE_NAME, "fs_nindir: 0x{0:X8}",    sb.fs_nindir);
        AaruConsole.Debug(MODULE_NAME, "fs_inopb: 0x{0:X8}",     sb.fs_inopb);
        AaruConsole.Debug(MODULE_NAME, "fs_optim: 0x{0:X8}",     sb.fs_optim);
        AaruConsole.Debug(MODULE_NAME, "fs_id_1: 0x{0:X8}",      sb.fs_id_1);
        AaruConsole.Debug(MODULE_NAME, "fs_id_2: 0x{0:X8}",      sb.fs_id_2);
        AaruConsole.Debug(MODULE_NAME, "fs_csaddr: 0x{0:X8}",    sb.fs_csaddr);
        AaruConsole.Debug(MODULE_NAME, "fs_cssize: 0x{0:X8}",    sb.fs_cssize);
        AaruConsole.Debug(MODULE_NAME, "fs_cgsize: 0x{0:X8}",    sb.fs_cgsize);
        AaruConsole.Debug(MODULE_NAME, "fs_ipg: 0x{0:X8}",       sb.fs_ipg);
        AaruConsole.Debug(MODULE_NAME, "fs_fpg: 0x{0:X8}",       sb.fs_fpg);
        AaruConsole.Debug(MODULE_NAME, "fs_fmod: 0x{0:X2}",      sb.fs_fmod);
        AaruConsole.Debug(MODULE_NAME, "fs_clean: 0x{0:X2}",     sb.fs_clean);
        AaruConsole.Debug(MODULE_NAME, "fs_ronly: 0x{0:X2}",     sb.fs_ronly);
        AaruConsole.Debug(MODULE_NAME, "fs_flags: 0x{0:X2}",     sb.fs_flags);
        AaruConsole.Debug(MODULE_NAME, "fs_magic: 0x{0:X8}",     sb.fs_magic);
