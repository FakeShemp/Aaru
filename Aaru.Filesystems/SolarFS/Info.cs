...
#region IFilesystem Members
                               ...
                               out FileSystem metadata)
    {
        ...
        AaruLogging.Debug(MODULE_NAME, "BPB.unk1: 0x{0:X2}",   bpb.unk1);
        AaruLogging.Debug(MODULE_NAME, "BPB.unk2: 0x{0:X4}",   bpb.unk2);
        ...
        AaruLogging.Debug(MODULE_NAME, "BPB.vol_name: \"{0}\"",   bpb.vol_name);
        AaruLogging.Debug(MODULE_NAME, "BPB.fs_type: \"{0}\"",    bpb.fs_type);
