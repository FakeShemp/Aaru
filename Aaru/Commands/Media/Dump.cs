...
sealed class DumpMediaCommand : Command<DumpMediaCommand.Settings>
{
    ...
    protected override int Execute(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        AaruLogging.Debug(MODULE_NAME, "--aacs-keydb-file={0}",         Markup.Escape(settings.AacsHostKeyFile ?? ""));
...
#region Nested type: Settings
    ...
    public class Settings : MediaFamily
    {
        ...
        [LocalizedDescription(nameof(UI.AacsHostKeyFile_help))]
        [CommandOption("--aacs-keydb-file")]
        [DefaultValue(null)]
        public string AacsHostKeyFile { get; init; }
    }
