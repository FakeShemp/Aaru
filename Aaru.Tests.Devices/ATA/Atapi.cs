...
static class Atapi
{
    internal static void Menu(string devPath, Device dev)
    {
        while(true)
        {
            ...
            AaruLogging.WriteLine(Localization.Send_an_ATAPI_command_to_the_device);
            AaruLogging.WriteLine(Localization.Send_IDENTIFY_PACKET_DEVICE_command);
    ...
    menu:
        AaruLogging.WriteLine(Localization.Device_0, devPath);
        AaruLogging.WriteLine(Localization.Sending_IDENTIFY_PACKET_DEVICE_to_the_device);
        ...
        AaruLogging.WriteLine(Localization.Return_to_ATAPI_commands_menu);
        AaruLogging.Write(Localization.Choose);
        ...
        {
            case 0:
                AaruLogging.WriteLine(Localization.Returning_to_ATAPI_commands_menu);

                return;
            case 1:
                Console.Clear();
                AaruLogging.WriteLine(Localization.Device_0, devPath);
                AaruLogging.WriteLine(Localization.IDENTIFY_PACKET_DEVICE_response);
