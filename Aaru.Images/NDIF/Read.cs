...
#region IMediaImage Members
    ...
    public ErrorNumber Open(IFilter imageFilter)
    {
        ...
        foreach(byte[] bcem in bcems.Select(_ => rsrc.GetResource(NDIF_RESOURCEID)))
        {
            ...
            AaruLogging.Debug(MODULE_NAME, "footer.sectors = {0}", _header.sectors);

            AaruLogging.Debug(MODULE_NAME, "footer.maxSectorsPerChunk = {0}", _header.maxSectorsPerChunk);

            AaruLogging.Debug(MODULE_NAME, "footer.dataOffset = {0}",      _header.dataOffset);
            AaruLogging.Debug(MODULE_NAME, "footer.crc = 0x{0:X7}",        _header.crc);
            AaruLogging.Debug(MODULE_NAME, "footer.segmented = {0}",       _header.segmented);
            AaruLogging.Debug(MODULE_NAME, "footer.p1 = 0x{0:X8}",         _header.p1);
            AaruLogging.Debug(MODULE_NAME, "footer.p2 = 0x{0:X8}",         _header.p2);
            AaruLogging.Debug(MODULE_NAME, "footer.unknown[0] = 0x{0:X8}", _header.unknown[0]);
            AaruLogging.Debug(MODULE_NAME, "footer.unknown[1] = 0x{0:X8}", _header.unknown[1]);
            AaruLogging.Debug(MODULE_NAME, "footer.unknown[2] = 0x{0:X8}", _header.unknown[2]);
            AaruLogging.Debug(MODULE_NAME, "footer.unknown[3] = 0x{0:X8}", _header.unknown[3]);
            AaruLogging.Debug(MODULE_NAME, "footer.unknown[4] = 0x{0:X8}", _header.unknown[4]);
            AaruLogging.Debug(MODULE_NAME, "footer.encrypted = {0}",       _header.encrypted);
            AaruLogging.Debug(MODULE_NAME, "footer.hash = 0x{0:X8}",       _header.hash);
            AaruLogging.Debug(MODULE_NAME, "footer.chunks = {0}",          _header.chunks);
            ...
            for(var i = 0; i < _header.chunks; i++)
            {
                ...
                AaruLogging.Debug(MODULE_NAME, "bHdr.chunk[{0}].type = 0x{1:X2}", i, bChnk.type);
        ...
        {
            AaruLogging.Error(Localization.Segmented_images_are_not_yet_supported);
