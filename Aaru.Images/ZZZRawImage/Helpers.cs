...
public sealed partial class ZZZRawImage
{
    MediaType CalculateDiskType()
    {
        ...
        switch(_imageInfo.ImageSize)
        {
            ...
            case 368640:
                return _extension == ".st" ? MediaType.DOS_35_SS_DD_9 : MediaType.DOS_525_DS_DD_9;

            case 409600:
                return _extension == ".st" ? MediaType.ATARI_35_SS_DD : MediaType.AppleSonySS;
            ...
            case 901120:
                return _extension == ".st" ? MediaType.ATARI_35_DS_DD_11 : MediaType.CBM_AMIGA_35_DD;
            ...
            case 656310272 when _imageInfo.SectorSize == 512:
                return MediaType.PD650;
            case 664829952 when _imageInfo.SectorSize == 512:
                return MediaType.PD650;
            case 1070617600:
