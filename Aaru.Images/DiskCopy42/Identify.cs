...
#region IWritableImage Members
    ...
    public bool Identify(IFilter imageFilter)
    {
        ...
        AaruConsole.Debug(MODULE_NAME, "tmp_header.diskName = \"{0}\"",      tmpHeader.DiskName);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.dataSize = {0} bytes",    tmpHeader.DataSize);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.tagSize = {0} bytes",     tmpHeader.TagSize);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.dataChecksum = 0x{0:X8}", tmpHeader.DataChecksum);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.tagChecksum = 0x{0:X8}",  tmpHeader.TagChecksum);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.format = 0x{0:X2}",       tmpHeader.Format);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.fmtByte = 0x{0:X2}",      tmpHeader.FmtByte);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.valid = {0}",             tmpHeader.Valid);
        AaruConsole.Debug(MODULE_NAME, "tmp_header.reserved = {0}",          tmpHeader.Reserved);
