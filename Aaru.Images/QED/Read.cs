...
#region IWritableImage Members
    ...
    public ErrorNumber Open(IFilter imageFilter)
    {
        ...
        AaruLogging.Debug(MODULE_NAME, "qHdr.cluster_size = {0}",        _qHdr.cluster_size);
        AaruLogging.Debug(MODULE_NAME, "qHdr.table_size = {0}",          _qHdr.table_size);
        AaruLogging.Debug(MODULE_NAME, "qHdr.header_size = {0}",         _qHdr.header_size);
        AaruLogging.Debug(MODULE_NAME, "qHdr.features = {0}",            _qHdr.features);
        AaruLogging.Debug(MODULE_NAME, "qHdr.compat_features = {0}",     _qHdr.compat_features);
        AaruLogging.Debug(MODULE_NAME, "qHdr.autoclear_features = {0}",  _qHdr.autoclear_features);
        AaruLogging.Debug(MODULE_NAME, "qHdr.l1_table_offset = {0}",     _qHdr.l1_table_offset);
        AaruLogging.Debug(MODULE_NAME, "qHdr.image_size = {0}",          _qHdr.image_size);
        ...
        {
            AaruLogging.Error(Localization.Cluster_size_must_be_a_power_of_2);
        ...
        {
            AaruLogging.Error(Localization.Cluster_size_must_be_between_4_Kbytes_and_64_Mbytes);
        ...
        {
            AaruLogging.Error(Localization.Table_size_must_be_a_power_of_2);
        ...
        {
            AaruLogging.Error(Localization.Table_size_must_be_between_1_and_16_clusters);
