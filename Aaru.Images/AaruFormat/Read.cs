...
#region IWritableOpticalImage Members
    ...
    public ErrorNumber Open(IFilter imageFilter)
    {
        ...
        if(_imageStream.Length < Marshal.SizeOf<AaruHeader>()) return ErrorNumber.InvalidArgument;
        ...
        {
            AaruConsole.Error(string.Format(Localization.Image_version_0_not_recognized,
        ...
        {
            AaruConsole.Error(Localization.Index_not_found);
            ...
            switch(entry.blockType)
            {
                ...
                case BlockType.MetadataBlock:
                       ...
                       metadataBlock.commentsLength + metadataBlock.commentsOffset <= metadata.Length)
                    {
                        ...
                        AaruConsole.Debug(MODULE_NAME, Localization.Setting_comments_0, _imageInfo.Comments);
                    }
...
#pragma warning restore IL2026
        ...
        if(!foundUserDataDdt)
        {
            AaruConsole.Error(Localization.Could_not_find_user_data_deduplication_table);
        ...
        AaruConsole.Debug(MODULE_NAME, Localization.Image_last_written_on_0, _imageInfo.LastModificationTime);
        ...
        if(_imageInfo.MetadataMediaType == MetadataMediaType.OpticalDisc)
        {
            if(Tracks != null)
            {
                ...
                if(leadOutFixed)
                    AaruConsole.Error(Localization.This_image_has_a_corrupted_track_list_convert_will_fix_it);
